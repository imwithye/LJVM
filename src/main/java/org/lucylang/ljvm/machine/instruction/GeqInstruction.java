...
/**
 * Created by imwit on 1/22/2016.
 */
public class GeqInstruction extends Instruction {
    public GeqInstruction(Operand<String> ref, Operand op1, Operand op2) {
        this.type = Type.GEQ;
