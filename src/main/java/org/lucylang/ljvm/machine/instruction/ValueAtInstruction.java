...
public class ValueAtInstruction extends Instruction {
    public ValueAtInstruction(Operand<String> ref, Operand op1, Operand op2) {
        this.type = Type.VALUEAT;
    ...
    public boolean executeValid(Machine vm, Module module) throws InvalidInstruction, TypeUnmatchedException, ValueUnavailableException, UndefinedException, OverdefinedException {
        ...
        result.assignValue(v1.valueAt(v2));
        return false;
    }
}
